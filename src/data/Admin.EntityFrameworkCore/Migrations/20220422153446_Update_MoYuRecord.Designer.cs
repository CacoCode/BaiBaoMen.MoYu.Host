...
namespace Magicodes.Admin.EntityFrameworkCore.Migrations
{
    ...
    [Migration("20220422153446_Update_MoYuRecord")]
    partial class Update_MoYuRecord
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Magicodes.Admin.Core.Attachments.AttachmentInfo", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Magicodes.Admin.Core.Attachments.ObjectAttachmentInfo", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Magicodes.Admin.Core.Authorization.OpenId.AppUserOpenId", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Magicodes.Admin.Core.Authorization.Roles.Role", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Magicodes.Admin.Core.Authorization.Users.User", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Magicodes.Admin.Core.Chat.ChatMessage", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Magicodes.Admin.Core.Contents.ArticleInfo", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Magicodes.Admin.Core.Contents.ArticleSourceInfo", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Magicodes.Admin.Core.Contents.ArticleTagInfo", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Magicodes.Admin.Core.Contents.ColumnInfo", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Magicodes.Admin.Core.Custom.MoYuRecords.MoYuRecord", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd();
                    ...
                    b.Property<DateTime>("MoYuRealTime");

                    b.Property<int>("MoYuType");

                    b.Property<int?>("TenantId");

                    b.Property<string>("TogetherWxUsers");

                    b.Property<long>("WxUserId");

                    b.HasKey("Id");

                    b.HasIndex("WxUserId");

                    b.ToTable("MoYuRecords");
                });

            modelBuilder.Entity("Magicodes.Admin.Core.Custom.WxUsers.WxUser", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Magicodes.Admin.Core.Friendships.Friendship", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Magicodes.Admin.Core.MultiTenancy.Accounting.Invoice", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Magicodes.Admin.Core.MultiTenancy.Payments.SubscriptionPayment", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Magicodes.Admin.Core.MultiTenancy.Tenant", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Magicodes.Admin.Core.Storage.BinaryObject", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Magicodes.Admin.Core.Editions.SubscribableEdition", b =>
                {
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("Magicodes.Admin.Core.Authorization.Roles.Role")
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("Magicodes.Admin.Core.Authorization.Users.User")
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Magicodes.Admin.Core.Attachments.ObjectAttachmentInfo", b =>
                {
                    b.HasOne("Magicodes.Admin.Core.Attachments.AttachmentInfo", "AttachmentInfo")
                        .WithMany()
            ...
            modelBuilder.Entity("Magicodes.Admin.Core.Authorization.OpenId.AppUserOpenId", b =>
                {
                    b.HasOne("Magicodes.Admin.Core.Authorization.Users.User", "User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
            ...
            modelBuilder.Entity("Magicodes.Admin.Core.Authorization.Roles.Role", b =>
                {
                    b.HasOne("Magicodes.Admin.Core.Authorization.Users.User", "CreatorUser")
                        .WithMany()
                        .HasForeignKey("CreatorUserId");

                    b.HasOne("Magicodes.Admin.Core.Authorization.Users.User", "DeleterUser")
                        .WithMany()
                        .HasForeignKey("DeleterUserId");

                    b.HasOne("Magicodes.Admin.Core.Authorization.Users.User", "LastModifierUser")
                        .WithMany()
            ...
            modelBuilder.Entity("Magicodes.Admin.Core.Contents.ArticleInfo", b =>
                {
                    b.HasOne("Magicodes.Admin.Core.Contents.ArticleSourceInfo", "ArticleSourceInfo")
                        .WithMany()
                        .HasForeignKey("ArticleSourceInfoId");

                    b.HasOne("Magicodes.Admin.Core.Contents.ColumnInfo", "ColumnInfo")
                        .WithMany()
            ...
            modelBuilder.Entity("Magicodes.Admin.Core.Contents.ArticleTagInfo", b =>
                {
                    b.HasOne("Magicodes.Admin.Core.Contents.ArticleInfo", "ArticleInfo")
            ...
            modelBuilder.Entity("Magicodes.Admin.Core.Custom.MoYuRecords.MoYuRecord", b =>
                {
                    b.HasOne("Magicodes.Admin.Core.Custom.WxUsers.WxUser", "WxUser")
                        .WithMany("MoYuRecords")
