        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AttachmentSorts = table.Column<int>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MaxItemCount = table.Column<int>(nullable: true),
                    IsStatic = table.Column<bool>(nullable: false),
                    IsHeaderNav = table.Column<bool>(nullable: false),
                    IsFooterNav = table.Column<bool>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsDeleted = table.Column<bool>(nullable: false),
                    TenantId = table.Column<int>(nullable: true),
                    WxUserId = table.Column<long>(nullable: false),
                    ImageUrl = table.Column<string>(nullable: true),
                    Desc = table.Column<string>(nullable: true),
                    MoYuRealTime = table.Column<DateTime>(nullable: false),
                    Integral = table.Column<int>(nullable: false),
                    MoYuType = table.Column<int>(nullable: false),
                    IsWorkTime = table.Column<bool>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_MoYuRecords", x => x.Id);
                    table.ForeignKey(
                        name: "FK_MoYuRecords_WxUsers_WxUserId",
                        column: x => x.WxUserId,
