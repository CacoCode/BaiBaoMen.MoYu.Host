...
//           All rights reserved
// 
//           filename : UserAppService_Create_Tests.cs
//           description :
// 
...
namespace Magicodes.Admin.Tests.Authorization.Users
{
    public class UserAppService_Create_Tests : UserAppServiceTestBase
    {
        ...
        private async Task CreateUserAndTestAsync(string userName, string name, string surname, string emailAddress,
            int? tenantId, params string[] roleNames)
        {
            //Arrange
